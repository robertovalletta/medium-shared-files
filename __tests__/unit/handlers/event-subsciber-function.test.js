// Import all functions from event-subscriber-function.js
const snsPayloadLogger = require('../../../src/handlers/subscriber/event-subscriber-function.js');

describe('Test for event publisher function', function () {
